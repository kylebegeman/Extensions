...
public extension Timer {
    ...
    static func runEvery(seconds: TimeInterval, handler: @escaping (Timer?) -> Void) -> Timer {
    ...
    static func runAfterDelay(seconds: Double, after: @escaping () -> Void) {
    ...
    ///   - after: the code block to be called after the delay.
    static func runAfterDelay(seconds: Double, queue: DispatchQueue, after: @escaping () -> Void) {
